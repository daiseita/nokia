...
public class ExeceltoDB_01 : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        oValue.setRequestPost("Action,A67F02NV0128,Url,FileName,DropDownList1,DropDownList2,A66D01");
        string strUrl = "";
        string strSQL = "";
        string strFileName = oValue.Data("FileName");
        A67F02NV0128 = oValue.Data("A67F02NV0128");
        string strRoute = pb.WebRoot + @"\Upload\global\type02\";
        /* 供應商代碼 */
        A61I05JJA19I02 = oValue.Data("DropDownList1");
        A61I12JJA12I02 = oValue.Data("DropDownList2");
        A66D01 = oValue.Data("A66D01");
    ...
    public string readExcel(string strRoute, string FileName, HttpContext context)
    {
        ...
        {
            string ItemNum = mergeDt.Rows[c][2].ToString();
            if (KeySum.ContainsKey(ItemNum))
            {
                KeySum[ItemNum] += 1;
            }
            else {
                KeySum.Add(ItemNum, 1);
            }
        }         
        ...
        foreach (KeyValuePair<string, int> kv in KeySum)
        {
            ...
            {
                ErrorMsg += Ms.Msg23 + " " + kv.Key.ToString();
                return "";
            }
            else {
                //將a61i02代碼 填入mergeDt 
                for (int x = 0; x < dt19.Rows.Count; x++)
                {
                    ...
                    for (int y = 0; y < mergeDt.Rows.Count; y++) {
                        string strC = mergeDt.Rows[y][2].ToString();
                        if (strC == PackNum)
                        {
        ...
        for (int a = 0; a < mergeDt.Rows.Count ; a++)
        {
            ...
            string PackN = mergeDt.Rows[a][4].ToString();
            string cA63I08 = mergeDt.Rows[a][0].ToString();
            string cA63I09 = mergeDt.Rows[a][1].ToString();
            string cA63I10 = mergeDt.Rows[a][2].ToString();
            string cA63I11 = mergeDt.Rows[a][3].ToString();
            string cA63I12 = mergeDt.Rows[a][4].ToString();
            string cA63I13 = mergeDt.Rows[a][5].ToString();
            string cA63I14 = mergeDt.Rows[a][6].ToString();
            string cA63I15 = mergeDt.Rows[a][7].ToString();
            string cA63I16 = mergeDt.Rows[a][8].ToString();
            string cCode1 = mergeDt.Rows[a][9].ToString();
            string cCode2 = mergeDt.Rows[a][10].ToString();
            string cCode3 = mergeDt.Rows[a][11].ToString();
            string cCode4 = mergeDt.Rows[a][12].ToString();
            string cCode5 = mergeDt.Rows[a][13].ToString();

            /* A62檢查 && 出貨日期填入*/
            existCheckA62(cA61I02);
            strSQL += setTimeA62(cA61I02);
            /* A63檢查 && 序號填入*/
            existCheckA63(cA61I02);
            /* A61b資料填入 */
            strSQL += setDataA61(cA61I02, cA61F01, PackN);
            strSQL += OrderItemAdd(A65I02UV0012, cA61I02, cA61I04, cA61I08, cA61I09, cA61I10, cA61F01, PackN);
            ...
            if (ChildDt != null)
            {
                if (cCode1 != "" && ChildDt.Rows.Count >= 1)
                {
                    ...
                    strSQL += ChildItemAdd(A65I02UV0012, nA61I02, nA61I04, cA61I08, cA61I09, cA61I10, n31F01, PackN, nParentID);
                    existCheckA62(nA61I02);
                    strSQL += setTimeA62(nA61I02);
    ...
    public string OrderItemAdd(string A65I02UV0012, string A66I02UV0019, string A61I04JJA31I02, string A61I08CV0001, string A61I09CV0001, string A61I10JJA61I02, string A61F01NV0064,string PackN)
    {
        DataTable dt = new DataTable();
        bool IsChild = false;
        string strSQL = "";      
    ...
    public string ChildItemAdd(string A65I02UV0012, string A66I02UV0019, string A61I04JJA31I02, string A61I08CV0001, string A61I09CV0001, string A61I10JJA61I02, string A61F01NV0064, string PackN, string ParentID)
    {
        DataTable dt = new DataTable();
        bool IsChild = false;
        string strSQL = "";
