...
public class A10_list_content_list : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        TableString = "select A67I01XA,A67I02UV0012,A67I03CV0001,A67F01NV0064,A67F02NV0128,A67IND,A67INT,A67INA from A67 where A67I03CV0001='L'";
        if (SerchWhere != "") {
        ...
        dt = null;
        SQL_s1 = "  select distinct A68D01 from A68 where A68I07CV0001='L' order by A68D01 desc ";
        Sql.ClearQuery();
        ...
        dt = null;
        SQL_s1 = "  select distinct A31I02UV0010,A31F01NV0064 from A31 where A31I05CV0001='L'  order by A31F01NV0064   ";
        Sql.ClearQuery();
