...
public class A10_list_content_list : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        Sql.SetSurround("And");
        Sql.SetWhere("and", "A31I11JJA31I02", "=","", true);
        ...
        TableString = "select A31I01XA,A31I02UV0010,A31I03CV0001,A31I04JJA30I02,A31I05CV0001,A31I06CV0001,A31I07CV0001,A31I08CV0001,A31I09CV0001,A31I10CV0001,A31I11JJA31I02,A31I12FD0200,A31I13II,A31I14CV0024,A31F01NV0064,A31F02NV0256,A31F03NV0004,A31F04FD0300,A31F05NV0256,A31F06NV0032,A30F01NV0064  from A31 left join A30 on A31I04JJA30I02=A30I02UV0004";
        Sql.SetColumnName("A31I01XA,A31I02UV0010,A31I03CV0001,A31I04JJA30I02,A31I05CV0001,A31I06CV0001,A31I07CV0001,A31I08CV0001,A31I09CV0001,A31I10CV0001,A31I11JJA31I02,A31I12FD0200,A31I13II,A31I14CV0024,A31F01NV0064,A31F02NV0256,A31F03NV0004,A31F04FD0300,A31F05NV0256,A31F06NV0032,A30F01NV0064");
        Sql.SetTableName("( " + TableString + " )A31 ");
        Sql.sqlTransferColumn = "A31I03CV0001,A31I05CV0001,A31I06CV0001,A31I07CV0001,A31I08CV0001,A31I09CV0001,A31I10CV0001";
        Sql.SetOrderBy("A31I02UV0010", false);
        Sql.RecordCountQuery("A31I02UV0010");
        dt = Sql.Query("A31", ThisPage, PageNum);
        ...
        if (dt != null)
        {
            ...
            for (int i = 0; i < DataSet1.Tables["A31"].Rows.Count; i++)
            {
                ...
                for (int s = 0; s < DataSet1.Tables["A31"].Columns.Count; s++)
                {
                    string ColumnName = DataSet1.Tables["A31"].Columns[s].ColumnName;

                    if (ColumnName == "A31INA")
                    {
                        string A31INA = DataSet1.Tables["A31"].Rows[i][s].ToString().Substring(0, 4) + "/" + DataSet1.Tables["A31"].Rows[i][s].ToString().Substring(4, 2) + "/" + DataSet1.Tables["A31"].Rows[i][s].ToString().Substring(6, 2) + " " + DataSet1.Tables["A31"].Rows[i][s].ToString().Substring(8, 2) + ":" + DataSet1.Tables["A31"].Rows[i][s].ToString().Substring(10, 2) + ":" + DataSet1.Tables["A31"].Rows[i][s].ToString().Substring(12, 2);
                        Input01_Value.Add(new ValueInput { value = A31INA });
                    }
                    else
                    {
                        Input01_Value.Add(new ValueInput { value = DataSet1.Tables["A31"].Rows[i][s].ToString() });
                    }
