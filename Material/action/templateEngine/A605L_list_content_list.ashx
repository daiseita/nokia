...
public class A10_list_content_list : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            Sql.SetWhere("or", "A68I03JJA67I02", "like", oValue.Data("SearchTxt"), true);                       
        }
        string TableString = "";
        //Sql.ClearQuery();
        ...
        {
            TableString = "SELECT DISTINCT A68I03JJA67I02,A68I13JJA12I02,A68INA  FROM A68 where ( A68I11CV0001='B' or A68I11CV0001='C' or A68I11CV0001='D') and A68I13JJA12I02='" + oValue.Data("A12I02UV0010") + "' ";
            Sql.SetColumnName("A68I03JJA67I02,A68I13JJA12I02,A68INA");
        }
        else {
            TableString = "SELECT A67I02UV0012 as A68I03JJA67I02,A67INA as A68I13JJA12I02 ,A67INA as A68INA FROM A67 ";
            Sql.SetColumnName("A68I03JJA67I02,A68I13JJA12I02,A68INA");
        }
        
        Sql.SetTableName("( " + TableString + " )A68 ");
        //Sql.sqlTransferColumn = "A30I03CV0001";
        Sql.SetOrderBy("A68INA", true);
        Sql.RecordCountQuery("A68I03JJA67I02");
