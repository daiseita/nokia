...
public partial class upload : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            case "A":
                UploadUrl = Server.MapPath("~") + @"\upload\local\type02\";
                Label1.Text = "";
                break;
            case "B":
                UploadUrl = Server.MapPath("~") + @"\upload\local\type04\";
                Label1.Text = "";
                break;
            case "C":
                UploadUrl = Server.MapPath("~") + @"\upload\local\type03\";
                Label1.Text = "";
                break;
            case "D":
                UploadUrl = Server.MapPath("~") + @"\upload\local\type04\";
        ...
        string SQL = "";
        Sql.ClearQuery();
        SQL = "select A12I02UV0010,A12I03CV0001,A12F01NV0064 from A12 where A12I03CV0001='B'";
