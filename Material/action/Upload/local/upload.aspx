...
<body>
    ...
    <div id="AjaxUploadBox">
        ...
        <div style="margin:0px 0px 5px 15px;width:90%;display:none;" >
            供應商:<asp:DropDownList ID="DropDownList2" style="font-size:12px;" runat="server"></asp:DropDownList> <br>
            承包商:<asp:DropDownList ID="DropDownList1" style="font-size:12px;" runat="server"></asp:DropDownList><br>
            日期:<asp:TextBox ID="A68D01" name="A68D01" class="A68D01" runat="server"></asp:TextBox>
        </div>
    ...
    <script type="text/javascript">
        ...
        function goUploadSQL(strType, strFileUrl, strFileName) {
            ...
            switch(strType) {
                case "A":
                    ajaxTagSubmit(ThisWebUrl + "/action/Webservice/local/ExeceltoDB_02.ashx", "AjaxUploadBox", 1);
                    break;
                case "B":
                    ajaxTagSubmit(ThisWebUrl + "/action/Webservice/local/ExeceltoDB_04.ashx", "AjaxUploadBox", 1);
                    break;
