<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadSerial.aspx.cs" Inherits="action_Upload_action_UploadSerial" %>
...
<body>
    ...
    <div id="AjaxUploadBox">
        <div style="margin:20px 0px 5px 15px;width:90%;"class="HYclearfix">
             ...
             <asp:Button ID="Button1" runat="server" Text="上傳Excel&啟動" class="btn btn-xs btn-info setCol_10" style="height:28px;" onclick="Button1_Click1" />            
        ...
        <asp:TextBox ID="A68I13JJA12I02" name="A68I13JJA12I02" class="A68I13JJA12I02" style="display:none;" runat="server"></asp:TextBox>
        <asp:TextBox ID="A68I04JJA31I02" name="A68I04JJA31I02" class="A68I04JJA31I02" style="display:none;" runat="server"></asp:TextBox>
        <asp:TextBox ID="A68I03JJA67I02" name="A68I03JJA67I02" class="A68I03JJA67I02" style="display:none;" runat="server"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function hideFlash(A68I03JJA67I02, A68I04JJA31I02, A68I13JJA12I02) {
            $("#ProcessIMG").css("display", "none");
            $("#Label1").html("");            
            wParent.LoadSerialList(A68I03JJA67I02,A68I04JJA31I02,A68I13JJA12I02);
        ...
        function goUploadSQL(strType, strFileUrl, strFileName) {
            ...
            ajaxTagSubmit(ThisWebUrl + "/action/Webservice/local/SerialImport_01.ashx", "AjaxUploadBox", 1);
