...
public class CountList : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        SQL = "select sum(UnImport)UnDev,sum(Import)Dev,sum(Total)Total,A31F01NV0064,A61I04JJA31I02 from  " +
                  "(select A61I04JJA31I02,CASE WHEN A61I11CV0001 = '' THEN 1 Else  0  END UnImport,CASE WHEN A61I11CV0001 <>'' THEN 1 Else  0  END " +
                  "Import,CASE WHEN A61I11CV0001= '' or  A61I11CV0001<>'' THEN 1 END Total from A61 where A61I09CV0001 <>'V' and A61I07CV0001='G' )A61 " +
                  " left join A31 on A61I04JJA31I02 = A31I02UV0010 group by A31F01NV0064,A61I04JJA31I02";
        dt = Sql.selectTable(SQL, "A60");
        oTemplate.SetTemplatesDir(pb.ActionTemplateName + "module/");
        oTemplate.SetTemplateFileCharset("A603L_countlist_content.html", "UTF-8");
