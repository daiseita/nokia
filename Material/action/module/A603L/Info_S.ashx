...
public class Info : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        oValue.setRequestGet("A67I02UV0012");
        string thisOut = "";
        ...
        {
            SQL = "select COUNT(A68I04JJA31I02 )cnt,A68I04JJA31I02,A68I13JJA12I02,L12.A12F01NV0064,A31F06NV0032,A31I08CV0001,R12.A12F01NV0064,A68D01  from A68 left join (select A12I02UV0010,A12F01NV0064 from A12)L12 " +
                  "on A68I13JJA12I02=L12.A12I02UV0010 left join (select A12I02UV0010,A12F01NV0064 from A12)R12 on A68I12JJA12I02=R12.A12I02UV0010 LEFT join A31 on A68I04JJA31I02=A31I02UV0010 where A68I03JJA67I02='" + oValue.Data("A67I02UV0012") + "' and A68I09CV0001=''" +
                  " group by A68I04JJA31I02,A68I13JJA12I02,L12.A12F01NV0064,R12.A12F01NV0064,A31F06NV0032,A31I08CV0001,A68D01 ";
