...
public class A10_list : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        oValue.setRequestGet("A31I02UV0010,A31F01NV0064");
        string thisOut = "";
        ...
        if (oValue.Data("A31I02UV0010") != "")
        {
            SQL = "select A31I01XA,A31I02UV0010,A31F01NV0064,A31I12FD0200  from A31 where A31I11JJA31I02='" + oValue.Data("A31I02UV0010") + "'";
