...
public class Select : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string SQL = "select A61I02UV0019  from  A60 left join A61 On A60I02UV0012 = A61I03JJA60I02  where A60I05CV0032 ='" + Parame + "'";
        string strWhere = "";
        dt = Sql.selectTable(SQL, "Chk");
        if (dt != null) {
            for (int u = 0; u < dt.Rows.Count; u++) {
                if (strWhere != "") { strWhere += " or "; }
                strWhere += "  A61I02UV0019='" + dt.Rows[u]["A61I02UV0019"].ToString() + "' "; 
            }        
        }
        if (strWhere != "") {
            dt = Sql.selectTable("select DISTINCT A61I04JJA31I02,A31F01NV0064 from A61 left join A31 on A61I04JJA31I02 = A31I02UV0010 where A61I11CV0001='A' and A61I10JJA61I02 = '' and ( " + strWhere + " )", "A61");                
        }                      
        if (dt!=null )
        {
