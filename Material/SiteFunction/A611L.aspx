<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A611L.aspx.cs" Inherits="SiteFunction_A611L"  %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A611L/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
