<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A13.aspx.cs" Inherits="SiteFunction_A13" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A13/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        			
