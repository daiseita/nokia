<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A12.aspx.cs" Inherits="SiteFunction_A12" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A12/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
