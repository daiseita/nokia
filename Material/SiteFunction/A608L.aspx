<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A608L.aspx.cs" Inherits="SiteFunction_A608L" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A608L/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
        </script>        	
