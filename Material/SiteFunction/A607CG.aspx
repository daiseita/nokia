<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A607CG.aspx.cs" Inherits="SiteFunction_A607CG" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A607L/list.ashx?action=<%=strType%>', 'HY-MainFrameBox', 1, 0);                       
          </script>        	
