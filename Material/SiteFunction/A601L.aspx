<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A601L.aspx.cs" Inherits="SiteFunction_A601L" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A601L/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
