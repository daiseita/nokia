<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A30.aspx.cs" Inherits="SiteFunction_A30" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A30/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
