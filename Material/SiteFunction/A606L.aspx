<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A606L.aspx.cs" Inherits="SiteFunction_A606L" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A606L/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
