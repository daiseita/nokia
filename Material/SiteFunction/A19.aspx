<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A19.aspx.cs" Inherits="SiteFunction_A19" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A19/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
