<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A11.aspx.cs" Inherits="SiteFunction_A11" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A11/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>   
