<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A20.aspx.cs" Inherits="SiteFunction_A20" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A20/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        
