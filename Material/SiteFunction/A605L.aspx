<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A605L.aspx.cs" Inherits="SiteFunction_A605L" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A605L/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
