<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A611G.aspx.cs" Inherits="SiteFunction_A611G" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A611G/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
