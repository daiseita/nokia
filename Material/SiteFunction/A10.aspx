<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A10.aspx.cs" Inherits="SiteFunction_A10" %>
...
<body>
    <form id="form1" runat="server">
        <div class="navbar navbar-default" id="navbar">
			...
			<div id="HY-TopFrameBox" ng-include="'<%= ResolveUrl("~/template/TopFrame_content.html") %>'"  >1234</div> 
		</div>
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					<div id="HY-TopMenuBar" ng-include="'<%= ResolveUrl("~/template/TopMenuBar_content.html") %>'" ></div>                    
					<div id="HY-MainFrameBox" ng-include="'<%= ResolveUrl("~/Module/A10/list.ashx") %>'" class="page-content"></div>
				</div>				
			</div>
