<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A604L.aspx.cs" Inherits="SiteFunction_A604L" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A604L/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
