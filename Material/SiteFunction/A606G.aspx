<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A606G.aspx.cs" Inherits="SiteFunction_A606G" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            ajaxTagFunction(ThisWebUrl + '/Module/A606G/list.ashx', 'HY-MainFrameBox', 1, 0);                                      
          </script>        	
