...
jQuery.autocomplete = function(input, options) {
    ...
    if (options.SelectType.Start) {    	    
    	$(input).wrap("<span class='"+options.SelectType.selectClass+"' title='"+options.SelectType.subject+"'></span>");    	    	
    	$(input).after("<a href='#' class='autocompleteBtn'> </a>");
    ...
    // Add to body element
    //alert(options.upDivElement);
    $(options.upDivElement).append(results);
    ...
    function findPos(obj) {
    	  ...
    	  if (options.upDivElement=="body") {
           ...
           var curleft = $(obj).position().left ||0;
...
jQuery.fn.autocomplete = function(url, options, data) {
    ...
    options.cellSeparator = options.cellSeparator || "|";  //分欄附號
    ...
    options.extraParams = options.extraParams || function(){return '';};
    ...
    options.upDivElement = options.upDivElement || "body";

    //2010-11-13 by wesley    
    //下拉式選單模式
    options.SelectType = options.SelectType || { };    
    options.SelectType.Start = options.SelectType.Start || false;
    //Class    
    options.SelectType.selectClass = options.SelectType.selectClass  || "autocompleteSelectBox";
    options.SelectType.subject = options.SelectType.subject  || "";
