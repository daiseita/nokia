...
public class A60_face : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        oValue.setRequestPost("Action,OrderDataString,A60I01XA,A60F02NV0128,A60I05CV0032,A61D01");
        ...
        else
        {
            ...
            try
            {
                string columnString = "A60I01XA,A60I02UV0012,A60I03CV0001,A60F01NV0064,A60F02NV0128,A60I05CV0032,A61D01";
        ...
        Sql.ClearQuery();
        SQL = "Select A31I02UV0010,A31F01NV0064,A31I06CV0001,A31I07CV0001,A31I08CV0001 From A31 where A31I11JJA31I02='' and A31I03CV0001='B'";
    ...
    public void OrderDataOperate(HttpContext context)
    {
        ...
        if (pContent != "")
        {
            ...
            for (int i = 0; i < OrderItem.Length; i++) {
                ...
                string strId = ItemData[0].Substring(0, 10);
                strSQL += OrderItemAdd(strId, ItemData[1], A60I02UV0012, ItemData[2]);
            }
        }
        string RtnMsg = Pub_Function.executeSQL(strSQL);
        switch (RtnMsg)
    ...
    string A61I08CV0001 = "";
    public string OrderItemAdd(string A61I04JJA31I02, string strNum, string A60I02UV0012 ,string A61D01) 
    {
        A61I08CV0001 = "";
        DataTable dt = new DataTable();
        bool IsChild = false;
        string strSQL = "";
        string SQL = "select A31I09CV0001,A31I06CV0001,A31I07CV0001,A31I08CV0001 from A31 where A31I02UV0010='" + A61I04JJA31I02 + "'";
        Sql.ClearQuery();
        ...
        if (dt == null)
        {
            ...
            if (dt.Rows[0]["A31I08CV0001"].ToString() == "V")
            {
                IsChild = true;
            }
        ...
        for (int x = 0; x < Num; x++)            
        {
            ...
            strSQL += OrderSQL_InsertA61(A60I02UV0012, A61I02UV0019, A60I02UV0012, A61I04JJA31I02, "", "", A61I08CV0001, dt.Rows[0]["A31F01NV0064"].ToString(), A61D01);                        
            ...
            if (IsChild == true) {
                ...
                if (dt != null) {               
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            str = A61I02.ToString();
                            A61I02UV0019 = A60I02UV0012 + str.PadLeft(7, Convert.ToChar("0"));
                            strSQL += OrderSQL_InsertA61(A60I02UV0012, A61I02UV0019, A60I02UV0012, dt.Rows[i]["A31I02UV0010"].ToString(), "V", A61I04JJA31I02, A61I08CV0001, dt.Rows[i]["A31F01NV0064"].ToString(), A61D01);
                        }                
                }
            }
        }  
    ...
    public string OrderSQL_InsertA60(string A60I02UV0012)
    {
        ...
        string A60I05CV0032 = oValue.Data("A60I05CV0032");
        Sql.ClearQuery();
        Sql.SetData("A60I02UV0012", A60I02UV0012);
        Sql.SetNData("A60I05CV0032", A60I05CV0032);
    ...
    /* 明細新增 */
    public string OrderSQL_InsertA61(string A60I02UV0012, string A61I02UV0019, string A61I03JJA60I02, string A61I04JJA31I02, string A61I09CV0001, string A61I10JJA61I02, string A61I08CV0001, string A61F01NV0064,string A61D01)
    {
        string strSQL = "";      
        Sql.ClearQuery();
        ...
        Sql.SetNData("A61F01NV0064", Pub_Function.setSingleQuotation(A61F01NV0064));
