...
public class A60_face : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        oValue.setRequestPost("Action,OrderDataString,A65I01XA,A65F02NV0128,A61I05JJA19I02,A60F02NV0128,A66D01");
        ...
        else
        {
            ...
            try
            {
                string columnString = "A60I01XA,A60I02UV0012,A60I03CV0001,A60F01NV0064,A60F02NV0128,A66D01";
    ...
    public void OrderDataOperate(HttpContext context)
    {
        ...
        if (pContent != "")
        {
            ...
            for (int i = 0; i < OrderItem.Length; i++) {
                ...
                string strA66D01 = ItemData[0].Substring(24, 8);
            ...
            {
                Sql.ClearQuery();
                SQL = "select top " + item.Value.ToString() + " A61I02UV0019,A61I05JJA19I02,A61I12JJA12I02 ,A61F01NV0064 from A61 where A61I04JJA31I02='" + item.Key.ToString() + "' and A61I11CV0001='' order by A61INA,A61I02UV0019 ";
        ...
        for (int p = 0; p < OrderDataSst.Tables.Count; p++) {
            ...
            for (int r = 0; r < OrderDataSst.Tables[p].Rows.Count; r++)
            {
                ...
                /* A61b資料填入 */
                strSQL += setDataA61(OrderDataSst.Tables[p].Rows[r]["A61I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A61I05JJA19I02"].ToString(), OrderDataSst.Tables[p].Rows[r]["A61I12JJA12I02"].ToString());
                strSQL += OrderItemAdd(A65I02UV0012, OrderDataSst.Tables[p].Rows[r]["A61I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A61I05JJA19I02"].ToString(), OrderDataSst.Tables[p].Rows[r]["A61I12JJA12I02"].ToString(), "", OrderDataSst.Tables[p].Rows[r]["A61F01NV0064"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66D01"].ToString());
                ...
                if (ChildDt != null)
                {
                    ...
                    {
                        strSQL += OrderItemAdd(A65I02UV0012, ChildDt.Rows[i]["A61I02UV0019"].ToString(), House, Providor, ParentID, ChildDt.Rows[i]["A31F01NV0064"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66D01"].ToString());
                    }
                }
            }
        }
    ...
    public string setDataA61(string A61I02UV0019, string A61I05JJA19I02, string A61I12JJA12I02)
    {
        string strSQL = "";
        Sql.ClearQuery();
    ...
    public string OrderItemAdd(string A65I02UV0012, string A66I02UV0019, string A61I05JJA19I02, string A61I12JJA12I02, string A61I10JJA61I02, string A61F01NV0064,string A66D01) 
    {
        DataTable dt = new DataTable();
        bool IsChild = false;
        string strSQL = "";
