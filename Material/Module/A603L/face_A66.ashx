    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (recordset != null)
        {
            for (int i = 0; i < recordset.Rows.Count; i++)
            {
                ...
                str = str.Replace("_", ""); str = str.Replace("'", ""); str = str.Replace("(", ""); str = str.Replace(")", ""); str = str.Replace(" ", ""); str = str.Replace(".", "");
    ...
    public void OrderDataOperate(HttpContext context)
    {
        ...
        if (pContent != "")
        {
            ...
            for (int i = 0; i < OrderItem.Length; i++)
            {
                ...
                string strA12I02P = ItemData[0].Substring(10, 10);
                string strA19I02 = ItemData[0].Substring(20, 4);
                string strA68D01 = ItemData[0].Substring(24, 8);
            ...
            foreach (KeyValuePair<string, int> item in codeArray)
            {
                ...
                Sql.ClearQuery();
                SQL = "select top " + item.Value.ToString() + " A66I02UV0019,A66I12JJA12I02,A66I13JJA12I02,A66I05JJA19I02,A66F01NV0064 from A66 where A66I04JJA31I02='" + cA31I02 + "' and A66I05JJA19I02='" + cA19I20 + "' and A66I11CV0001='A' order by A66INA,A66I02UV0019 ";
            ...
            for (int i = 0; i < OrderItem.Length; i++)
            {
                ...
                {
                    if (OrderDataSst.Tables[strA31I02 + strA19I02].Rows[x]["A66I13JJA12I02"] == "")
                    {
                        OrderDataSst.Tables[strA31I02 + strA19I02].Rows[x]["A66I13JJA12I02"] = strA12I02P;
                        OrderDataSst.Tables[strA31I02 + strA19I02].Rows[x]["A66I05JJA19I02"] = strA19I02;
                        OrderDataSst.Tables[strA31I02 + strA19I02].Rows[x]["A68D01"] = strA68D01;
                        couter = couter - 1;
                        if (couter == 0) { break; }
                    }
                }
        ...
        for (int p = 0; p < OrderDataSst.Tables.Count; p++)
        {
            ...
            {
                /* A62檢查 && 出貨日期填入*/
                existCheckA62(OrderDataSst.Tables[p].Rows[r]["A66I02UV0019"].ToString());
                strSQL += setTimeA62(OrderDataSst.Tables[p].Rows[r]["A66I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A68D01"].ToString());
                /* A61b資料填入 */
                strSQL += setDataA61(OrderDataSst.Tables[p].Rows[r]["A66I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I12JJA12I02"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I13JJA12I02"].ToString());
                strSQL += setDataA66(OrderDataSst.Tables[p].Rows[r]["A66I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I12JJA12I02"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I13JJA12I02"].ToString());
                strSQL += OrderItemAdd(A67I02UV0012, OrderDataSst.Tables[p].Rows[r]["A66I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I05JJA19I02"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I12JJA12I02"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I13JJA12I02"].ToString(), "", OrderDataSst.Tables[p].Rows[r]["A66F01NV0064"].ToString(), OrderDataSst.Tables[p].Rows[r]["A68D01"].ToString());

                string ParentID = OrderDataSst.Tables[p].Rows[r]["A66I02UV0019"].ToString();
                string Providor = OrderDataSst.Tables[p].Rows[r]["A66I12JJA12I02"].ToString();
                string Contractor = OrderDataSst.Tables[p].Rows[r]["A66I13JJA12I02"].ToString();
                SQL = "select A66I02UV0019,A31F01NV0064 from A66 left join  A31 on A66I04JJA31I02=A31I02UV0010 where A66I10JJA66I02='" + ParentID + "'";
                Sql.ClearQuery();
                DataTable ChildDt = new DataTable();
                ChildDt = Sql.selectTable(SQL, "A61ch");
                if (ChildDt != null)
                {
                    //string A67I02UV0012, string A68I02UV0019, string A61I12JJA12I02, string A61I13JJA12I02, string A61F01NV0064
                    for (int i = 0; i < ChildDt.Rows.Count; i++)
                    {
                        strSQL += OrderItemAdd(A67I02UV0012, ChildDt.Rows[i]["A66I02UV0019"].ToString(), OrderDataSst.Tables[p].Rows[r]["A66I05JJA19I02"].ToString(), Providor, Contractor, ParentID, ChildDt.Rows[i]["A31F01NV0064"].ToString(), OrderDataSst.Tables[p].Rows[r]["A68D01"].ToString());
                    }
                }
            }
        }                       
